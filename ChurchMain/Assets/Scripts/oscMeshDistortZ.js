...
public var oscAddFrequency : int;
public var amplitude : float;
public var oscAddAmplitude : int;
...
function Update () {
	...
	if(oscAddFrequency!=0){
		frequency = oscin.oscValuesOut[oscAddFrequency];
	}
	if(oscAddAmplitude!=0){
		amplitude = oscin.oscValuesOut[oscAddAmplitude];
	}
